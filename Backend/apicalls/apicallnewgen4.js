...
const config = new Configuration({
    apiKey: "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"
});

const openai = new OpenAIApi(config);
const runPrompt = asynchandler(async (question_type,difficulty,subtopics) => {
    let localMessages = [
        {"role": "user", "content": "You are a dsa problem generator just like leetcode."},
    ];
    let s;
    ...
    prompt1 = "Generate a "+question_type+" DSA question on the subtopics "+s+" of "+difficulty+" difficulty";
    else if (question_type=="MCQ")
    prompt1 = "Generate an "+question_type+"type DSA question on the subtopics "+subtopics+" of "+difficulty+" difficulty.Provide options. Do not provide solutions.";
    else
    prompt1 = "Generate a "+question_type+" type DSA question on the subtopics "+subtopics+" of "+difficulty+" difficulty. Do not provide solution";
    await delay(2000);
    ...
    let prompt2="";
    if(question_type=="Coding Question")
    prompt2="Provide the alogorithmic approach and the complete, syntactically correct C++ source code (not pseudocode) for solving the coding question:"+reply1+"This code should be able to be compiled and run without modifications. Also, include the time and space complexity analysis."
    else
    prompt2="Now that the problem has been generated: "+reply1+" .Now, please provide a very brief solution to this problem.";
